...
// ******************************************************************************************
//	@file Version: 1.0
//	@file Name: mission_AbandonedDrone.sqf
//	@file Author: [404] Deadbeat, [404] Costlyy, AgentRev
//  @file Edited: Sp4wN7 [G3iST]
//	@file Created: 08/12/2012 15:19
//	@file Edited: 02/24/2019 17:50
...
_setupVars =
{
	...
	[
		...
		"B_UAV_05_F",
		"B_UAV_05_F",
		"MQ4A Greyhawk Missile UAV"
	] call BIS_fnc_selectRandom;

	_missionType = "Abandoned Drone";
...
_setupObjects =
{
	...
	_missionHintText = format ["%1 <t color='%3'>%2</t> has been immobilized, National Stratis Agency agents are protecting it, go get it for your team!", _vehDeterminer, _vehicleName, mainMissionColor];	
};
