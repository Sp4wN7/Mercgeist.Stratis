...
_setupObjects =
{
	...
	_missionHintText = format ["A patrol consisting of a <t color='%4'>%1</t>, a <t color='%4'>%2</t> and a <t color='%4'>%3</t> is patrolling the island! Intel suggests they have a large sum of money and weapons!", _vehicleName, _vehicleName2, _vehicleName3, moneyMissionColor];
