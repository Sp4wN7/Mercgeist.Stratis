...
_setupVars =
{
	_missionType = "NSA Warrantless Searches";
...
_setupObjects =
{
	...
	_missionHintText = format ["The National Stratis Agency has taken over <br/><t size='1.25' color='%1'>%2</t><br/><br/>There seem to be <t color='%1'>%3 agents</t> conducting warrantless searches. Attack them and capture the seized items.<br/>Watch out for those windows!", sideMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Nice work!<br/><br/><t color='%1'>%2</t><br/>has been liberated!<br/>The seized contraband is now yours to take!", sideMissionColor, _townName];
