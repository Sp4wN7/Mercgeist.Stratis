...
_setupObjects =
{
	...
	_missionHintText = format ["The National Stratis Agency has emplaced a narcotics search roadblock. Go get their seized contraband.", sideMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = format ["You can now sell the contraband on the open market!"];
};
