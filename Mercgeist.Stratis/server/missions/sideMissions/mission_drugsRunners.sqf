...
_setupObjects =
{
	...
	_missionHintText = format ["Drug runners driving a <t color='%2'>%1</t> are moving drugs around Stratis. Stop them quickly!", _vehicleName, sideMissionColor];
...
/*	_explosivePos = getPosATL (_vehicles select 0);
	...
	_successHintMessage = "You have stopped the drug runners but they blew up their car! The dope is smoked, but the cash is crisp!";
};
