...
pp_create_terminal = {
 //Land_Laptop_unfolded_F
  ...
  private _offset = switch (true) do {
	...
	case (_garage isKindOf "Land_Destroyer_01_base_F"): { [8.6,55,10.9895]};	
    default { [0,0,0] };
  };
...
pp_create_terminals = {
...

  {
    ...
    _garage = (nearestObjects [_marker_pos, ["Land_i_Shed_Ind_F", "Land_Carrier_01_base_F", "Land_Destroyer_01_base_F"], 50]) select 0;
